...
<header class="navbar navbar-inverse navbar-fixed-top bs-docs-nav" role="banner">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="#" class="navbar-brand">Pracownik</a>
    </div>
    <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
      ...
      <li class="active">
        ...
        <li>
          <?php echo "<a href='./dashboard_pracownik.php?id={$id}'>Dane personalne i zlecenia</a>";?>
        </li>
        
        <li>
        <?php echo "<a href='./urlop_pracownik.php?id={$id}'>Urlopy</a>";?>
        </li>
...
echo "<div class='card'>";
    ...
    echo "<tr style='text-align:center;'>";
        ...
        echo "<tr style='text-align:center;'>";
            echo "<td style='text-align:center;'>{$pracownik->imie}</td>";
            echo "<td>{$pracownik->nazwisko}</td>";
            echo "<td>{$pracownik->stanowisko}</td>";
            echo "<td>";
            $id_wybranego_pracownika = $pracownik->id;
